...
void Helper::SaveTexture(GLuint texture, const string& fileName, const Vec2& pos, const Size& size) {
	...
	// rgb image
	//glCopyTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_viewport[0],m_viewport[1], m_viewport[2], m_viewport[3], 0);
	glCopyTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, p1.x, p1.y, width, height, 0);
