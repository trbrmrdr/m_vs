...
#ifdef FREEIMAGE_FORCE_COLORORDER_RGB
#undef FREEIMAGE_COLORORDER
#define FREEIMAGE_COLORORDER FREEIMAGE_COLORORDER_RGB
#endif
#ifdef FREEIMAGE_FORCE_COLORORDER_BGR
#undef FREEIMAGE_COLORORDER
#define FREEIMAGE_COLORORDER FREEIMAGE_COLORORDER_BGR
#endif
...
DLL_API FIICCPROFILE *DLL_CALLCONV FreeImage_CreateICCProfile(FIBITMAP *dib, void *data, DWORD size);
